              ...
              <div className="-mt-[1px]">
                  ...
                  <div className={`bg-white rounded-b-${radiusSize} p-4 pt-3 pb-8`}>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <p className="text-base font-normal text-gray-900">Row <span className="font-semibold">9</span> • Seat <span className="font-semibold">33</span></p>
                        <p className="text-xs text-gray-500">18010092353</p>
                      </div>
                    </div>
